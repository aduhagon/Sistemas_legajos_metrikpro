...
export default function ProveedorLoginPage() {
  ...
  async function handleLogin(e: React.FormEvent) {
    ...
    // window.location.assign — navegación completa que envía las cookies al server
    window.location.assign('/proveedor/portal')
  }
          ...
          {modo === 'login' ? (
            <>
              ...
              <div className="mt-4 text-center">
                <a href="/proveedor/registro" className="text-blue-400 hover:text-blue-300 text-xs">Registrarse →</a>
              </div>
            </>
          ) : (
            <>
