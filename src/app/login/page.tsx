      ...
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          ...
          <p className="text-zinc-500 text-sm">
            {modo === 'login' ? 'Acceso para colaboradores' : 'Recuperar contraseña'}
          </p>
        </div>
        ...
        <div className="bg-white/[0.03] border border-white/[0.08] rounded-2xl p-8">
          {modo === 'login' ? (
            <>
              <h1 className="text-white font-medium text-xl mb-2">Ingresar</h1>
              <p className="text-zinc-500 text-sm mb-6">Panel interno de evaluadores y administradores.</p>
        ...
        <p className="text-center text-zinc-600 text-xs mt-6">
          ¿Sos proveedor?{' '}
          <a href="/proveedor/login" className="text-blue-400 hover:text-blue-300 transition-colors">
            Ingresá por aquí
          </a>
        </p>
      </div>
