        ...
        {obligatoriosSinCargar > 0 && proveedor.estado !== 'APROBADO' && (
          <div className="bg-yellow-500/5 border border-yellow-500/20 rounded-xl px-4 py-3 mb-4 flex items-center gap-2">
            ...
            <span className="text-yellow-400 text-sm">
              Faltan {obligatoriosSinCargar} documento(s) obligatorio(s) para poder aprobar el legajo
            </span>
          </div>
        )}
        ...
        <div className="bg-white/[0.03] border border-white/[0.08] rounded-2xl overflow-hidden">
          <div className="px-6 py-4 border-b border-white/[0.06]">
            ...
            <p className="text-zinc-500 text-xs mt-0.5">
              Aprobá o rechazá cada documento. Podés corregir la fecha de vencimiento si es incorrecta.
            </p>
          </div>
            ...
            {docs.map((doc: any) => {
              ...
              return (
                <div key={doc.id} className="px-6 py-4">
                  ...
                  {/* Acciones del evaluador: fecha editable + aprobar/rechazar */}
                  <AccionesDocumento
                    docId={doc.id}
                    estado={doc.estado}
