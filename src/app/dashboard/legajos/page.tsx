    ...
    <div className="min-h-screen bg-[#0f1117] text-white p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex gap-2 mb-6 flex-wrap">
          {['Todos', 'Pendiente', 'En revisión', 'Aprobado', 'Rechazado'].map(f => (
            <span key={f} className="bg-white/[0.05] border border-white/[0.08] text-zinc-400 text-xs px-3 py-1.5 rounded-full cursor-pointer hover:bg-white/[0.08] transition-all">
              {f}
            </span>
          ))}
        </div>
